config = {
    defaultRepairPrice = 600, -- Repair price that is used if a vehicle-specific price is not available
    baseRepairPrice = 0, -- Starting repair price. Every player's vehicle damage (0-1000) is added to it later. If the final price is 0 or less, the repair menu does not appear
    repairPriceMultiplier = 1.0, -- Every player's vehicle damage (0-1000) is multiplier by this number, and then added to the base repair price
    allowGovPlateIndex = true, -- Setting this to true will allow all vehicles to purchase gov plate index 'Blue on White #3' (only for emergency vehicles otherwise)
    acePerm = 'customs.admin',
}
